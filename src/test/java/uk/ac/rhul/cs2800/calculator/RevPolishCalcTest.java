...
public class RevPolishCalcTest {
  ...
  void testInvalidEvaluation() {
     ...
     * 
     * To get this test to work I first had to create the StandardCalc class with an evaluate
     * method which inherits from the Calculator super class.
     */
  ...
  void testValidEvaluation() 
      ...
      EmptyStackException {
    /*
     * This test ensures that the evaluate method of the RevPolishCalc class
     * returns the correct answer of the String expression.
     */
  ...
  void testEvaluationWithUnbalancedOperands() {
    /*
     * This test ensures that the evaluate method of the RevPolishCalc class
     * throws an InvalidExpressionException if the operands of an expression are 
     * unbalanced (i.e. 3 + ...).
     * 
     * To make this test work, I had to add a check at the end of the evaluate method
     * of the RevPolishCalc class which determines if the number stack still contains more
     * than one item. If it does, then the given expression is invalid so it will throw
  ...
  void testPerformOperation() {
    /*
     * This test ensures that the correct result is returned for each operation
     * passed into the performOperation method of the RevPolishCalc class.
     */
  ...
  void testPerformOperationInvalidSymbol() {
    /*
     * This test ensures that calling the performOperation method returns 
     * the Float.MAX_VALUE when the passed symbol is invalid.
     */
  ...
  void testPerformOperationZeroDivision() {
    /*
     * This test ensures that a divide by zero error is thrown if 

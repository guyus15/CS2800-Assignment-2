...
/**
 * Is a State design pattern designed to encapsulate RevPolishCalc and StandardCalc classes so they
 * can be used under the same class.
 *
...
public class CalcModel {
  ...
  /**
   * Toggles the state of the calculator between standard and reverse Polish.
   *
   * @param isInfix a boolean determining if the calculator should be infix or not. Will be postfix
   *        if this is false.
   */

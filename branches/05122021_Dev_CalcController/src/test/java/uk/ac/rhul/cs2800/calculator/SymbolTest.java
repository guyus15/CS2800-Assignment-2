...
public class SymbolTest {
  ...
  void testStringToSymbol() {
    /*
     * This test ensures the symbol's toSymbol method
     * returns the expected Symbol.
     * 
     * To make this test work I had to add another method to the 
     * Symbol enum which will iterator through each of the enum's values
     * looking for one which matches the symbol string. If it finds one
     * it will returns that symbol, otherwise it will return an invalid 
     * symbol.
     */
